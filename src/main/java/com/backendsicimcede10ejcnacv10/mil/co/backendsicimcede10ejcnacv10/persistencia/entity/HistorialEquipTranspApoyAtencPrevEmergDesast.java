...
@Table(name = "TABLA_HISTORIAL_EQUIP_TRANSP_APOY_ATENC_PREV_EMERG_DESAST")//REFERENCIA A LA TABLA DE LA BASE DE DATOS.
public class HistorialEquipTranspApoyAtencPrevEmergDesast {
    ...
    @Column(name = "ID_HISTORIAL_EQUIP_TRANSP_APOY_ATENC_PREV_EMERG_DESAST", columnDefinition="NUMBER(20) NOT NULL")
    private Long idHistorialEquipTranspApoyAtencPrevEmergDesast;
    
    @Column(name = "NUM_REG_HISTORIAL_EQUIP_TRANSP_APOY_ATENC_PREV_EMERG_DESAST", columnDefinition="VARCHAR2(150) NOT NULL")
    ...
    @Column(name = "DIAS_EMPLEADOS_EQUIPO_TRANSPORTE", columnDefinition="NUMBER(20) NOT NULL")
    private Long diasEmpleadosEquipoTransporte;
    
    /*//DECLARACIÓN DE LOS MÉTODOS SETTERS Y GETTERS DE LAS VARIABLES DECLARADAS DE LOS CAMPOS DE LA TABLA DE LA BASE DE DATOS DE LA ENTIDAD:
    public Long getIdHistorialEquipTranspApoyAtencPrevEmergDesast() {
        return idHistorialEquipTranspApoyAtencPrevEmergDesast;
    }
    public void setIdHistorialEquipTranspApoyAtencPrevEmergDesast(Long idHistorialEquipTranspApoyAtencPrevEmergDesast) {
        this.idHistorialEquipTranspApoyAtencPrevEmergDesast = idHistorialEquipTranspApoyAtencPrevEmergDesast;
    }
    public String getNumRegHistorialEquipTranspApoyAtencPrevEmergDesast() {
        return numRegHistorialEquipTranspApoyAtencPrevEmergDesast;
    }
    public void setNumRegHistorialEquipTranspApoyAtencPrevEmergDesast(String numRegHistorialEquipTranspApoyAtencPrevEmergDesast) {
        this.numRegHistorialEquipTranspApoyAtencPrevEmergDesast = numRegHistorialEquipTranspApoyAtencPrevEmergDesast;
    }
    ...
    public Long getDiasEmpleadosEquipoTransporte() {
        return diasEmpleadosEquipoTransporte;
    }
    public void setDiasEmpleadosEquipoTransporte(Long diasEmpleadosEquipoTransporte) {
        this.diasEmpleadosEquipoTransporte = diasEmpleadosEquipoTransporte;
    }*/
}
