...
public class Funcionalidad {
    ...
    @Column(name = "ID_FUNCIONALIDAD", columnDefinition="NUMBER(20) NOT NULL")
    private Long idFuncionalidad;
    
    @Column(name = "NOMBRE_FUNCIONALIDAD", columnDefinition="VARCHAR2(150) NOT NULL")
    private String nombreFuncionalidad;
    
    @Column(name = "NOMBRE_ICONO_MENU_PRINCIPAL_FUNCIONALIDAD", columnDefinition="VARCHAR2(150) NULL")
    private String nombreIconoMenuPrincipalFuncionalidad;
    
    @Column(name = "LABEL_MENU_PRINCIPAL_FUNCIONALIDAD", columnDefinition="VARCHAR2(150) NULL")
    ...
    public String getLabelIconoMenuPrincipalFuncionalidad() {
        return labelIconoMenuPrincipalFuncionalidad;
    }
    public void setLabelIconoMenuPrincipalFuncionalidad(String labelIconoMenuPrincipalFuncionalidad) {
        this.labelIconoMenuPrincipalFuncionalidad = labelIconoMenuPrincipalFuncionalidad;
    }*/
}
