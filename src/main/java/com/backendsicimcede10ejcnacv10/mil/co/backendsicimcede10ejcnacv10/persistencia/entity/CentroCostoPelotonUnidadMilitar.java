...
@Table(name = "TABLA_CENTROS_COSTOS_PELOTONES_UNIDADES_MILITARES")//REFERENCIA A LA TABLA DE LA BASE DE DATOS.
public class CentroCostoPelotonUnidadMilitar {
    ...
    @Column(name = "ID_CENTRO_COSTO_PELOTON_UNIDAD_MILITAR", columnDefinition="NUMBER(20) NOT NULL")
    ...
    public Long getIdCentroCostoPelotonUnidadMilitar() {
        return idCentroCostoPelotonUnidadMilitar;
    }
    public void setIdCentroCostoPelotonUnidadMilitar(Long idCentroCostoPelotonUnidadMilitar) {
        this.idCentroCostoPelotonUnidadMilitar = idCentroCostoPelotonUnidadMilitar;
    }
