...
@Table(name = "TABLA_CENTROS_COSTOS_COMPANIAS_UNIDADES_MILITARES")//REFERENCIA A LA TABLA DE LA BASE DE DATOS.
public class CentroCostoCompaniaUnidadMilitar {
    ...
    @Column(name = "ID_CENTRO_COSTO_COMPANIA_UNIDAD_MILITAR", columnDefinition="NUMBER(20) NOT NULL")
    ...
    public Long getIdCentroCostoCompaniaUnidadMilitar() {
        return idCentroCostoCompaniaUnidadMilitar;
    }
    public void setIdCentroCostoCompaniaUnidadMilitar(Long idCentroCostoCompaniaUnidadMilitar) {
        this.idCentroCostoCompaniaUnidadMilitar = idCentroCostoCompaniaUnidadMilitar;
    }
